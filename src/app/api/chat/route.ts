...
- Use Figma-style layout structure: responsive grids, consistent spacing, alignment, and clear modular sections.
- 🖼️ For all images:
  - Only use valid, working URLs from Unsplash, Pexels, or embedded SVGs.
  - Never leave an image blank or broken.
  - Ensure **key feature images** (e.g., under “Features” or “Highlights”) are **appropriately scaled to fill their container** — not small like avatars or profile pictures. Images must be visually impactful, taking up the full width/height of their layout box.
